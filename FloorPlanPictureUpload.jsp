        ...
        if(isMultipart)
        {
            ...
            while(itr.hasNext())
            {
               ...
               else
               {
                    ...
                    String file_path=proj_path.getParentFile().getParentFile().getPath()+"\\web\\LivingSuppliers\\FloorPlanImages\\";
                    Random r=new Random();
            ...
            String columns = "livingSpaceID,floorName,totalRooms,genderCategory,floorType,floorImage";

            String queryInsert="insert into floorplan("+columns+") values ("+values1+")";
            ...
            {                            
                ...
                response.sendRedirect("FloorPlan.jsp?flag=1&livingSpaceID=" + value[4] + "&livingSpaceName=" + value[5] );
