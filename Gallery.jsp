            ...
            <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                <li class="breadcrumb-item text-center">
                    <h3 class="font-35 font-weight-bold fables-main-text-color text-danger">
                        <!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
                        Upload Gallery Images for <%=livingSpaceName%> (ID: <%=livingSpaceID%>)
                    </h3>
...
<div class="col-12 col-md-12 offset-md-1 mt-12" > 
    ...
    <div class="row mb-4 mb-md-12 overflow-hidden"> 
        <div class="col-12 col-sm-5 wow fadeInLeft">
            <form class="fables-contact-form" action="GalleryPictureUpload.jsp" enctype="multipart/form-data" method="post">    
                <table class="custom-table">
                    <tr>
                        <td><label for="featureName">Image Heading :</label></td>
                        <td><input type="text" id="featureName" name="imageHeading"></td>
                    </tr>
                    
                    <tr>
                        <td><label for="featureIcon">Gallery Image:</label></td>
                        <td><input type="file" id="featureIcon" name="galleryImage"></td>
                    </tr>
                    <tr>
                        <td>
                           ...
                           <div class="card rounded-0 mb-4">
                               <div class="row">
                                   <div class="fables-product-img col-12"> 
                                      <img class="card-img-top rounded-0" src='GalleryImages\<%=rs2.getString("galleryImage")%>' width="200" height="200" alt="Gallery">
                                  ...
                                  <div class="card-body col-12">
                                    <h5 class="card-title mx-xl-3" style="text-align: center;">
                                        <a href="#" class="fables-main-text-color fables-store-product-title fables-second-hover-color"><%=rs2.getString("galleryImageHead")%></a>
                                    </h5>
                                    <p class="fables-product-info">
                                        <a href="DeleteGallery.jsp?flag=1&galleryImageID=<%=rs2.getString("galleryImageID")%> &galleryImageHead=<%=rs2.getString("galleryImageHead")%> &livingSpaceID=<%=livingSpaceID%> &livingSpaceName=<%=livingSpaceName%>  " class="btn fables-second-border-color fables-second-text-color fables-btn-rouned fables-hover-btn-color font-14 p-2 px-2 px-xl-4">
