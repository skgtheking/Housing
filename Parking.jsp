            ...
            <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                <li class="breadcrumb-item text-center">
                    <h3 class="font-35 font-weight-bold fables-main-text-color text-danger">
                        <!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
                        Insert parking of <%=livingSpaceName%> (ID: <%=livingSpaceID%>)
                    </h3>
...
<div class="col-12 col-md-12 offset-md-1 mt-12" > 
    ...
    <div class="row mb-4 mb-md-12 overflow-hidden"> 
        <div class="col-12 col-sm-5 wow fadeInLeft">
            <form class="fables-contact-form" action="ParkingPictureUpload.jsp" enctype="multipart/form-data" method="post">    
                <table class="custom-table">
                    <tr>
                        <td><label for="parkingType">Parking Type:</label></td>
                        <td>
                    ...
                    <tr>
                        <td><label for="parkingArea">Parking Area (In Sqr Meter):</label></td>
                        <td><input type="text" id="parkingArea" name="parkingArea"></td>
                    </tr>
                    <tr>
                        <td><label for="distance">Distance from Living Area(In Meter):</label></td>
                        <td><input type="text" id="parkingArea" name="distance"></td>
                    </tr>
                    <tr>
                        <td><label for="parkingImage">Parking Image:</label></td>
                        <td><input type="file" id="featureIcon" name="parkingImage"></td>
                    </tr>
                    <tr>
                        <td>
           ...
           <div class="col-12 col-md-8 col-lg-9"> 
                <div class="row mb-4">
                    <div class="fables-light-background-color col-12">
                        <h2>Parking of <%=livingSpaceName%> (ID: <%=livingSpaceID%>)</h2>
                    </div>
                </div>
                <div class="row">
                           ...
                           <div class="card rounded-0 mb-4">
                               <div class="row">
                                   <div class="fables-product-img col-12"> 
                                      <img class="card-img-top rounded-0" src='ParkingImages\<%=rs2.getString("parkingImage")%>' width="200" height="200" alt="parking Image">
                                  ...
                                  <div class="card-body col-12">
                                    <h5 class="card-title mx-xl-3" style="text-align: center;">
                                        <a href="#" class="fables-main-text-color fables-store-product-title fables-second-hover-color">Type:<%=rs2.getString("parkingType")%></a>
                                    </h5>
                                    <h5 class="card-title mx-xl-3" style="text-align: center;">
                                        <a href="#" class="fables-main-text-color fables-store-product-title fables-second-hover-color">Area:<%=rs2.getString("parkingArea")%> Sqrft</a>
                                    </h5>
                                    <h5 class="card-title mx-xl-3" style="text-align: center;">
                                        <a href="#" class="fables-main-text-color fables-store-product-title fables-second-hover-color">Distance: <%=rs2.getString("distance")%> Meter </a>
                                    </h5>
                                    <p class="fables-product-info">
                                        <a href="DeleteParking.jsp?flag=1&livingSpaceParkingID=<%=rs2.getString("parkingID")%> &parkingType=<%=rs2.getString("parkingType")%> &livingSpaceID=<%=livingSpaceID%> &livingSpaceName=<%=livingSpaceName%>  " class="btn fables-second-border-color fables-second-text-color fables-btn-rouned fables-hover-btn-color font-14 p-2 px-2 px-xl-4">
