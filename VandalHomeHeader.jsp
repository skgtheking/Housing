        ...
        <div class="row">
            <div class="col-12 col-md-10 col-lg-9 pr-md-0">                       
                <nav class="navbar navbar-expand-md btco-hover-menu py-lg-2">         
                     ...
                     <div class=" navbar-collapse" id="fablesNavDropdown"> 

                         <ul class="navbar-nav fables-nav">   
                             <li >
                                 <a class="nav-link " href="VandalHomePage.jsp">
                                     Home
                                 </a>                                       
                             </li>

                             <li class="nav-item dropdown">
                                 <a class="nav-link " href="VandalProfile.jsp" >
                                     Profile
                                 </a>                                       
                             </li>
                             ...
                             <li class="nav-item dropdown">
                                 ...
                                 <ul class="dropdown-menu" aria-labelledby="sub-nav2">
                                     ...
                                     <li><a class="dropdown-item " href="Step1_EmergencyContact.jsp">Residence Housing</a></li>
                                     <li><a class="dropdown-item " href="Step1_EmergencyContact.jsp">Apartment Housing</a></li>
                                 </ul>
                             </li> 
                             <li class="nav-item dropdown">
                                 <a class="nav-link dropdown-toggle" href="#" id="sub-nav2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                 ...
                                 <ul class="dropdown-menu" aria-labelledby="sub-nav2">
                                     <li><a class="dropdown-item " href="Step1_EmergencyContact.jsp">Emergency Contact</a></li>
                                     <li><a class="dropdown-item " href="Step2_MorePersonalInfo.jsp">More Personal Info</a></li>
                                     <li><a class="dropdown-item " href="Step3_SelectApartment.jsp">Select Apartment</a></li>
...
<%
String SSNvandalID=session.getAttribute("vandalID").toString();   
String SSNvandalName=session.getAttribute("vandalName").toString();   
%>    
