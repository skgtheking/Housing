...
<!-- HEADER ONE ENDS-->
<%   
String livingSpaceParkingID= "";
String livingSpaceID= "";
String livingSpaceName= "";

livingSpaceParkingID=request.getParameter("livingSpaceParkingID");
...
{    
    ...
    String queryDelete="delete from parking where parkingID="+livingSpaceParkingID;
    ...
    else
    {
     ...
     response.sendRedirect("Parking.jsp?flag=1&livingSpaceID=" + livingSpaceID + "&livingSpaceName=" + livingSpaceName );
}
...
<div class="container"> 
    ...
    <div class="row mb-4 mb-md-5 overflow-hidden">
        <div class="col-12 col-sm-6 wow fadeInLeft">   
            ...
            + " from parking WHERE parkingID="+livingSpaceParkingID;
            ...
            %>
                <table class="custom-table" brder="1">
                                <div class="fables-product-img col-12" style="text-align: center;">
                                      <img src='ParkingImages\<%=rs.getString("parkingImage")%>' width="200" height="200"  alt="">
                    ...
                    <tr>
                        ...
                        <td><%=livingSpaceParkingID%></td>
                    </tr>

                    <tr>
                        <td>Parking Type:</td>
                        <td><%=rs.getString("parkingType")%></td>
                    </tr>

                    <tr>
                        <td> Parking Area:</td>
                        <td><%=rs.getString("parkingArea")%></td>
                    </tr>
