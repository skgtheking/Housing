        ...
        if(isMultipart)
        {
            ...
            while(itr.hasNext())
            {
               ...
               else
               {
                    ...
                    String file_path=proj_path.getParentFile().getParentFile().getPath()+"\\web\\LivingSuppliers\\RoomImages\\";
                    Random r=new Random();
            ...
            String columns = "livingSpaceID,roomNumber,floorPlanID,noVandalsCanOccupy,roomDescription,roomImages";

            String queryInsert="insert into rooms("+columns+") values ("+values1+")";
            ...
            {                            
                ...
                response.sendRedirect("Rooms.jsp?flag=1&livingSpaceID=" + value[4] + "&livingSpaceName=" + value[5] );
