...
<!-- HEADER ONE ENDS-->
<%   
String livingSpaceMealPlanID= "";
String livingSpaceID= "";
String livingSpaceName= "";

livingSpaceMealPlanID=request.getParameter("livingSpaceMealPlanID");
...
{    
    ...
    String queryDelete="delete from mealplan where mealPlanID="+livingSpaceMealPlanID;
    ...
    else
    {
     ...
     response.sendRedirect("MealPlan.jsp?flag=1&livingSpaceID=" + livingSpaceID + "&livingSpaceName=" + livingSpaceName );
}
...
<div class="container"> 
    ...
    <div class="row mb-4 mb-md-5 overflow-hidden">
        <div class="col-12 col-sm-6 wow fadeInLeft">   
            ...
            + " from mealplan WHERE mealPlanID="+livingSpaceMealPlanID;
            ...
            %>
                <table class="custom-table" brder="1">
                                <div class="fables-product-img col-12" style="text-align: center;">
                                      <img src='MealPlan\<%=rs.getString("mealImage")%>' width="200" height="200"  alt="Image is Loading..">
                    ...
                    <tr>
                        <td>Meal Plan ID:</td>
                        <td><%=livingSpaceMealPlanID%></td>
                    </tr>

                    <tr>
                        <td>Meal Plan Name:</td>
                        <td><%=rs.getString("mealName")%></td>
                    </tr>
