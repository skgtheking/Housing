...
<html>
    ...
    <body>
        ...
        if(isMultipart)
        {
            ...
            String values1="'"+value[2]
            +"','"+value[0]        
            +"','"+value[1]
            +"','"+fn
            +"'";
             
            String columns = "livingSpaceID,amenitiesName,description,amenitiesIcon";

            String queryInsert="insert into livingspaceamenities("+columns+") values ("+values1+")";
            ...
            {                            
                ...
                response.sendRedirect("Amenities.jsp?flag=1&livingSpaceID=" + value[2] + "&livingSpaceName=" + value[3] );
