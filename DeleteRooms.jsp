...
<!-- HEADER ONE ENDS-->
<%   
String livingSpaceRoomID= "";
String livingSpaceID= "";
String livingSpaceName= "";

livingSpaceRoomID=request.getParameter("livingSpaceRoomID");
...
{    
    ...
    String queryDelete="delete from rooms where roomID="+livingSpaceRoomID;
    ...
    else
    {
     ...
     response.sendRedirect("Rooms.jsp?flag=1&livingSpaceID=" + livingSpaceID + "&livingSpaceName=" + livingSpaceName );
}
...
<div class="container"> 
    ...
    <div class="row mb-4 mb-md-5 overflow-hidden">
        <div class="col-12 col-sm-6 wow fadeInLeft">   
            ...
            + " from rooms WHERE roomID="+livingSpaceRoomID;
            ...
            %>
                <table class="custom-table" brder="1">
                                <div class="fables-product-img col-12" style="text-align: center;">
                                      <img src='RoomImages\<%=rs.getString("roomImages")%>' width="200" height="200"  alt="Room Images">
                    ...
                    <tr>
                        <td>Living Space Room ID:</td>
                        <td><%=livingSpaceRoomID%></td>
                    </tr>
                    ...
                    <tr>
                        <td>Number of Vandals Can Occupy:</td>
                        <td><%=rs.getString("noVandalsCanOccupy")%></td>
                    </tr>
                    <tr>
                        <td> Room Description:</td>
                        <td><%=rs.getString("roomDescription")%></td>
                    </tr>
