        ...
        if(isMultipart)
        {
            ...
            while(itr.hasNext())
            {
               ...
               else
               {
                    ...
                    String file_path=proj_path.getParentFile().getParentFile().getPath()+"\\web\\LivingSuppliers\\GalleryImages\\";
                    Random r=new Random();
            ...
            String values1="'"+value[1]
            +"','"+value[0] 
            +"','"+fn
            +"'";
             
            String columns = "livingSpaceID,galleryImageHead,galleryImage";

            String queryInsert="insert into galleryimages("+columns+") values ("+values1+")";
            ...
            {                            
                ...
                response.sendRedirect("Gallery.jsp?flag=1&livingSpaceID=" + value[1] + "&livingSpaceName=" + value[2] );
