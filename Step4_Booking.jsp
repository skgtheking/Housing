            ...
            <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                <li class="breadcrumb-item text-center">
                    <h3 class="font-20 font-weight-bold fables-main-text-color text-danger">                       
                       Emergency Contact-> More Information->Select Living Space->Book Now
                    </h3>
...
<!-- Start page content --> 
                ...
                {                                   
                %>
                <div class="fables-choose-background fables-after-overlay py-4 py-md-12 bg-rules overflow-hidden px-3 px-md-0">
                    <div class="container position-relative z-index">    
                        ...
                        <div class="row">  
                            ...
                            <!-- CHOOSE DIV START--> 
                            <div class="col-12 col-lg-12 bg-white px-12 py-3 py-md-12 wow fadeInRight" data-wow-delay="1s" data-wow-duration="1.5s">                    
                                ...
                                <h3 class="font-30 font-weight-bold " style="text-align: center; text-transform: uppercase;"> 
                                    Rate : $ <%=rs.getString("ratePerSemester")%> (Per Semester)
                                </h3> 
                                <p class="fables-main-text-color font-14 my-3" style="text-align: center; font-size: 22px; font-weight: bold;">
                                    Location: <%=rs.getString("location")%> | Type: <%=rs.getString("type")%>
                                </p>
                                
                                <p class="fables-product-info">
                                    <a href="Payment.jsp?flag=1 &livingSpaceID=<%=livingSpaceID%>  &livingSpaceName=<%=rs.getString("livingSpaceName")%> &ratePerSemester=<%=rs.getString("ratePerSemester")%> " class="btn fables-second-border-color fables-second-text-color fables-btn-rouned fables-hover-btn-color font-14 p-2 px-2 px-xl-4">
                                        <span class="fables-iconToDelete">  <i class="fas fa-plus"></i> </span> 
                                        <span class="fables-btn-value">PAY NOW</span>
                                    </a>
                                </p>            
                                ...
                                <div id="<%=rs.getString("livingSpaceID")%>">
                                      ...
                                      <div class="card border-0 mb-2">
                                        ...
                                        <div id="C1+<%=rs.getString("livingSpaceID")%>" class="collapse show" aria-labelledby="headingOne" data-parent="#<%=rs.getString("livingSpaceID")%>">
                                      ...
                                      <div class="card border-0 mb-2">                                  
                                        ...
                                        <div id="C2+<%=rs.getString("livingSpaceID")%>" class="collapse show" aria-labelledby="headingTwo" data-parent="#<%=rs.getString("livingSpaceID")%>">
                                          <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
                                      ...
                                      <div class="card border-0 mb-2">
                                        ...
                                        <div id="C3+<%=rs.getString("livingSpaceID")%>" class="collapse show" aria-labelledby="headingThree" data-parent="#<%=rs.getString("livingSpaceID")%>">
                                          <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
                                      ...
                                      <div class="card border-0 mb-2">
                                        ...
                                        <div id="C4+<%=rs.getString("livingSpaceID")%>" class="collapse show" aria-labelledby="headingfour" data-parent="#<%=rs.getString("livingSpaceID")%>">
                                          <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
                                      ...
                                      <div class="card border-0 mb-2">
                                        ...
                                        <div id="C5+<%=rs.getString("livingSpaceID")%>" class="collapse show" aria-labelledby="headingfive" data-parent="#<%=rs.getString("livingSpaceID")%>">
                                          <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
                                      ...
                                      <div class="card border-0 mb-2">
                                        ...
                                        <div id="C6+<%=rs.getString("livingSpaceID")%>" class="collapse show" aria-labelledby="headingsix" data-parent="#<%=rs.getString("livingSpaceID")%>">
                                          <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
                                      ...
                                      <div class="card border-0 mb-2">
                                        ...
                                        <div id="C7+<%=rs.getString("livingSpaceID")%>" class="collapse show" aria-labelledby="headingseven" data-parent="#<%=rs.getString("livingSpaceID")%>">
                                          <div class="card-body fables-forth-text-color font-14 py-1 py-xl-2 pl-6 pr-0">
