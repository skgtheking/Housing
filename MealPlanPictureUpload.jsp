        ...
        if(isMultipart)
        {
            ...
            while(itr.hasNext())
            {
               ...
               else
               {
                    ...
                    String file_path=proj_path.getParentFile().getParentFile().getPath()+"\\web\\LivingSuppliers\\MealPlan\\";
                    Random r=new Random();
            ...
            String columns = "livingSpaceID,mealName,mealType,ratePerSemester,mealImage";

            String queryInsert="insert into mealplan("+columns+") values ("+values1+")";
            ...
            {                            
                ...
                response.sendRedirect("MealPlan.jsp?flag=1&livingSpaceID=" + value[3] + "&livingSpaceName=" + value[4] );
