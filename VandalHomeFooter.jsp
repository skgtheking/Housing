        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4 mb-4 mb-lg-0">
                ...
                <p class="font-15 fables-third-text-color">
                    Living in an apartment should involve respecting the property and the rights of others.
                    <br><br>
                    Apartments are not a place, it's a feeling. Whether it's a sprawling house or a cozy apartment, 
                    as long as you're surrounded by the ones you love, you're home.
                </p> 
            ...
            <div class="col-12 col-sm-6 col-lg-4">
               ...
               <div class="my-3">
                    ...
                    <p class="font-14 fables-fifth-text-color mt-2 ml-4">709 Deakin Ave, Moscow, ID 83844, United States</p>
                </div>
                <div class="my-3">
                    ...
                    <p class="font-14 fables-fifth-text-color mt-2 ml-4"> +1 208-885-6163</p>
                </div>
                <div class="my-3">
                    ...
                    <p class="font-14 fables-fifth-text-color mt-2 ml-4">vandalLiving@website.com</p>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-lg-4">
...
<div class="copyright fables-main-background-color mt-0 border-0 white-color">
        ...
        <p class="mb-0">Copyright © vandal Living 2023. All rights reserved.</p> 
