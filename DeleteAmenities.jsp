...
<!-- HEADER ONE ENDS-->
<%   
String livingSpaceAmenitiesID= "";
String livingSpaceID= "";
String livingSpaceName= "";

livingSpaceAmenitiesID=request.getParameter("livingSpaceAmenitiesID");
...
{    
    ...
    String queryDelete="delete from livingspaceamenities where livingSpaceAmenitiesID="+livingSpaceAmenitiesID;
    ...
    else
    {
     ...
     response.sendRedirect("Amenities.jsp?flag=1&livingSpaceID=" + livingSpaceID + "&livingSpaceName=" + livingSpaceName );
}
...
<div class="container"> 
    ...
    <div class="row mb-4 mb-md-5 overflow-hidden">
        <div class="col-12 col-sm-6 wow fadeInLeft">   
            ...
            + " from livingspaceamenities WHERE livingSpaceAmenitiesID="+livingSpaceAmenitiesID;
            ...
            %>
                <table class="custom-table" brder="1">
                                <div class="fables-product-img col-12" style="text-align: center;">
                                      <img src='LivingImages\<%=rs.getString("amenitiesIcon")%>' width="200" height="200"  alt="dress fashion">
                    ...
                    <tr>
                        <td>Living Space Amenities ID:</td>
                        <td><%=livingSpaceAmenitiesID%></td>
                    </tr>

                    <tr>
                        <td>Amenities Name:</td>
                        <td><%=rs.getString("amenitiesName")%></td>
                    </tr>
